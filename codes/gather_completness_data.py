...
dual_cats = os.listdir("/storage/splus/Catalogues/iDR5/idr5/single/")
...
def sum_to_final_results(args):
    ...
    try:
        # Read FITS file
        tab = Table.read(f"/storage/splus/Catalogues/iDR5/idr5/single/{tablename}")
        ...
        control.critical(f"Error processing {e} {tablename}")
...
if __name__ == "__main__":
    ...
    df.to_csv("../data/single.csv", index=False)